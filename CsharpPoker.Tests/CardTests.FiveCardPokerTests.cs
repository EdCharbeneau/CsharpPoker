...
using CsharpPoker.Ranks;

namespace CsharpPoker.Tests
{

    public class FiveCardPokerTests
    {
        [Fact]
        public void CanScoreHighCard()
        {
            ...
            scorer.GetScore().Name.Should().Be("High card");
        }
        ...
        public void CanScoreTwoPair()
        {
            ...
            scorer.GetScore().Name.Should().Be("Two pair");
        }
        ...
        public void CanScoreFourOfAKind()
        {
            ...
            scorer.GetScore().Name.Should().Be("Four of a kind");
        }
